...
public final class CryptoUtilities {
    ...
    private static final int WITNESSLIMIT = 49;
    ...
    public static void reduceToGCD(NaturalNumber n, NaturalNumber m) {
        ...
        if (!m.isZero()) {
            ...
            NaturalNumber n1 = new NaturalNumber2(temp.divide(m));
    ...
    public static boolean isEven(NaturalNumber n) {
         ...
         */
        int r = n.divide(new NaturalNumber2(2)).toInt();
        n.multiply(new NaturalNumber2(2));
        n.add(new NaturalNumber2(r));
        return r == 0;
    }
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        if (p.isZero()) {
            ...
            if (isEven(p)) {
                ...
                p.subtract(new NaturalNumber2(1));
                p.divide(new NaturalNumber2(2));
                powerMod(n, p, m);
            }
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        boolean wit = false;
        NaturalNumber w2 = new NaturalNumber2(0);
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            while (holder && counter <= WITNESSLIMIT) {
                n.subtract(new NaturalNumber2(2));
                NaturalNumber random = randomNumber(n);

                while (random.compareTo(new NaturalNumber2(2)) < 0) {
                    random = randomNumber(n);
                }
                n.add(new NaturalNumber2(2));
                holder = !isWitnessToCompositeness(random, n);
                counter++;
            }
        }
        return holder;
...
//        final int pi = 99999;
//        final int mi = 3;
//        NaturalNumber n = new NaturalNumber2(ni);
//        NaturalNumber p = new NaturalNumber2(pi);
//        NaturalNumber m = new NaturalNumber2(mi);
//
//        out.print(isEven(n));
//
//        powerMod(n, p, m);
